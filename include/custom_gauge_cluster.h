#ifndef ATG_ENGINE_SIM_CUSTOM_GAUGE_CLUSTER_H
#define ATG_ENGINE_SIM_CUSTOM_GAUGE_CLUSTER_H
...
class CustomGaugeCluster : public UiElement {
    public:
        CustomGaugeCluster();
        virtual ~CustomGaugeCluster();
