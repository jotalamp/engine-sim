...
//get left stíck x-axis
float Joystick::LSx() {
	int T = j_State.Gamepad.sThumbLX;
	return T / 65535.0f;
}

//get left stíck y-axis
float Joystick::LSy() {
	int T = j_State.Gamepad.sThumbLY;
	return T / 65535.0f;
}

float Joystick::RSx()
{
	int T = j_State.Gamepad.sThumbRX;
	return T / 65535.0f;
}

//get right stíck y-axis
float Joystick::RSy() {
	int T = j_State.Gamepad.sThumbRY;
	return T / 65535.0f;
}
