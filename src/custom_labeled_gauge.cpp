#include "../include/custom_labeled_gauge.h"
...
CustomLabeledGauge::CustomLabeledGauge() {
    m_gauge = nullptr;
    m_title = "";
    m_precision = 2;
    m_unit = "";
...
void CustomLabeledGauge::initialize(EngineSimApplication *app) {
...
void CustomLabeledGauge::destroy() {
    UiElement::destroy();
}

void CustomLabeledGauge::update(float dt) {
    UiElement::update(dt);
}

void CustomLabeledGauge::render() {
